...
@Component({
  ...
  standalone: true,
  imports: [NgSwitch, NgSwitchDefault, NgSwitchCase, TextFieldComponent, NgIf, FormsModule, PortalModule, ShapesContainerComponent]
})
export class AppComponent implements OnInit, AfterViewInit{
  ...
  createSquare = () => {
    ...
    setTimeout(() => {
      this.attachShapeEvent(this.container.id);
    }, 50)
